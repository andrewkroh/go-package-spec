...
func mapPackagesParams(v *pkgspec.Manifest, elasticsearchPrivilegesCluster any, policyTemplatesBehavior sql.NullString, dirName string, conditionsKibanaVersion sql.NullString, conditionsElasticSubscription sql.NullString, agentPrivilegesRoot sql.NullBool) InsertPackagesParams {
	return InsertPackagesParams{
		...
		DeprecatedDescription:              toNullString(v.Deprecated.Description),
		DeprecatedReplacedByDataStream:     toNullString(v.Deprecated.ReplacedBy.DataStream),
		DeprecatedReplacedByInput:          toNullString(v.Deprecated.ReplacedBy.Input),
		DeprecatedReplacedByPackage:        toNullString(v.Deprecated.ReplacedBy.Package),
		DeprecatedReplacedByPolicyTemplate: toNullString(v.Deprecated.ReplacedBy.PolicyTemplate),
		DeprecatedReplacedByVariable:       toNullString(v.Deprecated.ReplacedBy.Variable),
		DeprecatedSince:                    toNullString(v.Deprecated.Since),
